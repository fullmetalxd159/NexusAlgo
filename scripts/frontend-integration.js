 ...
 * This file demonstrates how to integrate Nexusalgo with a web frontend
 */

// For React/Vue/Angular applications
export class NexusalgoClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NexusalgoClient(provider, contractAddress);
